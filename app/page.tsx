  ...
  <img src="/profile.jpeg" alt="Aishath Ahmad Tibenda" className="w-full h-full object-cover" />
      ...
      <section id="contact" className="bg-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <a href="mailto:aishathtibenda03@gmail.com" className="inline-block bg-blue-600 text-white px-10 py-4 rounded-full text-lg font-bold hover:bg-blue-700 transition shadow-lg">
            Send Me an Email
          </a>
        </div>
      </section>
